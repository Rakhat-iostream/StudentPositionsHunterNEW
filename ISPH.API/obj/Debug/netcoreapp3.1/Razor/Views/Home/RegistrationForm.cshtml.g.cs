#pragma checksum "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\RegistrationForm.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "10f7242280639e2ffffc00de61a281cb6eed7d1c"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"10f7242280639e2ffffc00de61a281cb6eed7d1c", @"/Views/Home/RegistrationForm.cshtml")]
        ...
        <form id=""registration"" method=""post"" onsubmit=""RegisterUser();"">
            ...
            <div class=""form-model"" style=""margin-top: 30px;"">
                <div class=""input-container"">
                    ...
                    <inpu");
            WriteLiteral(@"t class=""input-field"" type=""text"" placeholder=""Enter your first name..."" id=""FirstName"">
                </div>
    ...
    $('#registration').submit(function (e) {
        ...
        if (user === 'employer') {
           ...
           ");
            ...
            if (isValid === true) $('#regerror').html(""Fi");
            WriteLiteral(@"ll all fields"");
            else {
                $.ajax({
                    type: ""POST"",
                    async: false,
