#pragma checksum "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Profile.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "84e976dd8d141c8cc80e98ad841c6868c1b85edc"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"84e976dd8d141c8cc80e98ad841c6868c1b85edc", @"/Views/Home/Profile.cshtml")]
                    ...
                    if (user.hasOwnProperty('companyName')) {
                        ...
                        for (let i = 0; i < ads.length; i++) {
                            $('.employerads').append('<div class=""ads""><div class=""signs""><form class=""deleteads""><button type=""submit""><i class=""fas fa-trash-alt""></i></button></form>' +
                                '</div>");
            WriteLiteral(@"<h2 class=""ads-title"">' + ads[i].title + '</h2><a href=""/home/advertisements/id=' + ads[i].advertisementId + '"">Learn more...</a></div>'
                                + '<div class=""empty""></div>');
                        }
...
#nullable disable
            WriteLiteral("\"\r\n                                },\r\n                                async: false,\r\n                                url: \"");
#nullable restore
#line 172 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Profile.cshtml"
                                 Write(url);
                        ...
                        $('#changeemail-form').submit(function (e) {
                            ...
                            $.ajax({
                                ...
                                headers: {
                                    'Authorization': ""Bearer ");
#nullable restore
#line 202 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Profile.cshtml"
                                                        Write(HttpContextAccessor.HttpContext.Session.GetString("Token"));
...
#nullable disable
            WriteLiteral("\"\r\n                                },\r\n                                async: false,\r\n                                url: \"");
#nullable restore
#line 205 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Profile.cshtml"
                                 Write(url);
...
#nullable disable
            ...
            WriteLiteral(@"              LastName: user.lastName,
                        ...
                        $('#company-field').append('<h5 id=""changecompanyinfo"" style=""margin-top: 20px""></h5><form id=""changecompany-form""><select class=""custom-select"" id=""CompanyName"">'
                            + '<option>Выберите вашу компанию...</option></select><br><button type=""submit"">Отправить</button></form>');
                        $.get(
                            '/companies'
                        ).done(function (data) {
            ...
            WriteLiteral(@"reventDefault();
                                ...
                                alert(JSON.stringify(employerdto));
                                $.ajax({
                                method: ""PUT"",
                                headers: {
                                    'Authorization': ""Bearer ");
...
#nullable disable
            WriteLiteral(@"/update/company"",
                                ...
                                contentType: ""application/json; charset=utf-8"",
                                success: function (data) {
                                    $('#changecompany-form').hide();
                                    $('#changecompanyinfo').html(""<span style='color: mediumspringgreen;'>Company updated successfully</span>"");
                                },
                                error: function (data) {
                                    alert(JSON.stringify(data));
    ...
    <ul class=""changedataul"">
        ...
        <");
            WriteLiteral("/li>\r\n    </ul>\r\n    ");
#nullable restore
#line 302 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Profile.cshtml"
