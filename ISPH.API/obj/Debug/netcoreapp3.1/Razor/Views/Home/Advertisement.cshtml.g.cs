#pragma checksum "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisement.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9e5229c37bad99008102a82d1b734c5a283c06c5"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9e5229c37bad99008102a82d1b734c5a283c06c5", @"/Views/Home/Advertisement.cshtml")]
    public class Views_Home_Advertisement : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9e5229c37bad99008102a82d1b734c5a283c06c53122", async() => {
            }
            );
...
#nullable disable
        ...
        if (userName !== '') {
            let role = '");
#nullable restore
#line 110 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisement.cshtml"
                   Write(HttpContextAccessor.HttpContext.Session.GetString("Role"));
...
#nullable disable
            WriteLiteral("\';\r\n            let resume = null;\r\n            if (role !== \'\') {\r\n                $.get(\r\n                    \'/users/students/id=");
#nullable restore
#line 114 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisement.cshtml"
                                   Write(HttpContextAccessor.HttpContext.Session.GetInt32("Id"));
            ...
            hubConnection.on('SendResume', function (url) {
                $.get(
                    ...
                    $('#chatroom').append('<form style=""margin: 20px 0;"" action=""' + url + '"" method=""post"" enctype=""multipart/form-data"">' +
                        '<button type=""submit"" class=""signout hoverbtn"" style=""background-col");
            WriteLiteral(@"or: mediumspringgreen; pad""> ' + data.name + '</button></form>');
                });
            });
...
#nullable restore
#line 145 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisement.cshtml"
                                             Write(HttpContextAccessor.HttpContext.Session.GetInt32("Id"));
...
<div class=""adsblock"">
    ...
    <div class=""chat"">
        ...
        <div id=""inputForm"" style=""margin-bottom: 30px"">
            <textarea placeholder=""Введите здесь сообщение..."" type=""text"" id=""message"" style=""background: black; border: none; color: white; padding: 15px; font-size: 1");
            WriteLiteral("8px;\"></textarea>\r\n            <button type=\"button\" id=\"sendBtn\" class=\"signout hoverbtn\" style=\"background: dodgerblue; padding: 10px 20px; margin-left: 20px;\">Отправить</button>\r\n");
#nullable restore
#line 215 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisement.cshtml"
...
#nullable restore
#line 218 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisement.cshtml"
