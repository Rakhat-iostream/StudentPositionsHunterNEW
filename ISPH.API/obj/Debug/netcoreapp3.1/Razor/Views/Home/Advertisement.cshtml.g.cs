#pragma checksum "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisement.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3d59582f4cadb0c54ff2dd1287d1466711d9641e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3d59582f4cadb0c54ff2dd1287d1466711d9641e", @"/Views/Home/Advertisement.cshtml")]
    public class Views_Home_Advertisement : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3d59582f4cadb0c54ff2dd1287d1466711d9641e3122", async() => {
            }
            );
            ...
            hubConnection.on('SendResume', function (url) {
                $.get(
                    ...
                    $('#chatroom').append('<form style=""margin: 20px 0;"" action=""' + url + '"" method=""post"" enctype=""multipart/form-data"">' +
                        '<button type=""submit"" class=""signout hoverbtn"" style=""backgr");
            WriteLiteral(@"ound-color: mediumspringgreen; pad""> ' + data.name + '</button></form>');
                });
            });
...
<div class=""adsblock"">");
    ...
    <div class=""chat"">
        ...
        <div id=""inputForm"" style=""margin-bottom: 30px"">
            ...
            <button type=""button"" id=""sendBtn"" class=""signout hoverbtn"" style=""background: dodgerblue; padding: 10px 20px; margin-");
            WriteLiteral("left: 20px;\">Отправить</button>\r\n");
#nullable restore
#line 211 "C:\Users\ASUS\source\repos\ISPH\ISPH.API\Views\Home\Advertisement.cshtml"
